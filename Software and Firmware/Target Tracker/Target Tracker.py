...
def writePositions(cx, cy, targetAquired):
	...
	while GPIO.input(37) == 1:
		nothing
		if ((GPIO.input(35) == 0) or (GPIO.input(31) == 1)):
				break
...
#SERIAL COMMS SETUP
ser = serial.Serial(port='/dev/ttyS0', baudrate = 230400, parity = serial.PARITY_NONE, stopbits=serial.STOPBITS_ONE, bytesize=serial.EIGHTBITS, timeout=1)
